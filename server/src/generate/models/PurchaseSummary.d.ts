...
export type GetPurchaseSummaryGroupByPayload<T extends PurchaseSummaryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<PurchaseSummaryGroupByOutputType, T['by']> & {
