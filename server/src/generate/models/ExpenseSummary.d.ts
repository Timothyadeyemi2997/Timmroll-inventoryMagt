...
export type GetExpenseSummaryGroupByPayload<T extends ExpenseSummaryGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<ExpenseSummaryGroupByOutputType, T['by']> & {
